...
#Add library target
set(PACKAGE_NAME labust-xml)
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "XML extension library for LABUST applications.")
set(CPACK_DEBIAN_PACKAGE_DEPENDS "labust-tools (>=0.59), libxml2 (>=2.7.6)")
include($ENV{CMAKE_CONFIG_DIR}/CPackConfig.cmake)
include(CPack)

#Library test code
#Gyros
add_executable(gyros_test src/test/gyros_test.cpp)
target_link_libraries(gyros_test ${PROJECT_NAME})
#XML
add_executable(xml_test src/test/xml_test.cpp)
